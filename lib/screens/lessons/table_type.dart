  ...
  void nextLesson() {
    ...
    if (!allShown) {
      if (subListStart < data!.length) {
        ...
        textToSpeechProvider.playFullAudio(result: newData, snapshot: widget.snapshot, filename: filename);
                                ...
                                child: Table(
                                    ...
                                    children: List<Map<String, dynamic>>.from(newData ?? []).map((item) {
                                      ...
                                      return TableRow(children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: CustomText(text: item[orderedKeys[3]]),
                                        ),
                                      ]);
                                    }).toList())))
                        : Expanded(
                                ...
                                child: Table(
                                    ...
                                    children: List<Map<String, dynamic>>.from(newData ?? []).map((item) {
                                      ...
                                      return TableRow(children: [
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: CustomText(text: item[orderedKeys[0]], size: 10),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: CustomText(text: item[orderedKeys[1]], size: 10),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: CustomText(text: item[orderedKeys[2]], size: 10),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: CustomText(text: item[orderedKeys[3]], size: 10),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: CustomText(text: item[orderedKeys[4]], size: 10),
                                        ),
                                      ]);
                                    }).toList()))),
            Spacer(flex: 1),
