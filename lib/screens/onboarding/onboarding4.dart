...
import 'package:french_app/screens/onboarding/onboarding5.dart';
...
class Onboarding4 extends StatefulWidget {
  ...
  const Onboarding4({super.key, required this.progressVal, required this.userModel});
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: getVerticalSize(15, context)),
              CustomText(
                text: 'What is your purpose for learning French? Choose one or more options',
              ...
              Expanded(
                  child: StreamBuilder<DocumentSnapshot>(
                      stream: FirebaseFirestore.instance.collection("onboarding").doc("purposeForLearning").snapshots(),
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: CustomButton(
                    ...
                    onpressed: () {
                      UserModel userModel = widget.userModel.copyWith(purposeForLearning: List<String>.from(selectedVals));
                      changeScreen(context, Onboarding5(progressVal: progressVal, userModel: userModel));
                    },
                  ),
                ),
              ),
