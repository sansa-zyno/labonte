...
import 'package:french_app/screens/onboarding/onboarding_finished.dart';
...
class Onboarding6 extends StatefulWidget {
  ...
  const Onboarding6({super.key, required this.progressVal, required this.userModel});
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: getVerticalSize(15, context)),
              CustomText(
                text: 'Where did you hear about Labonte French?',
              ...
              Expanded(
                  child: StreamBuilder<DocumentSnapshot>(
                      stream: FirebaseFirestore.instance.collection("onboarding").doc("heardAboutUs").snapshots(),
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: CustomButton(
                    ...
                    onpressed: () {
                      UserModel userModel = widget.userModel.copyWith(heardAboutUs: selectedVal);
                      changeScreen(context, OnboardingFinished(userModel: userModel));
                    },
                  ),
                ),
              ),
