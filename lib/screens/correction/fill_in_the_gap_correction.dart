        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: getVerticalSize(15, context)),
              widget.correction.fillInTheGap!.type.toString().contains('word-all')
                  ? Expanded(
                      flex: 10,
                      child: ListView.separated(
                          ...
                          itemBuilder: (ctx, rowIndex) {
                            ...
                            if (text.toLowerCase() == answers[rowIndex].toLowerCase()) {
                              correctAnswerCount++;
                            }
                            return Padding(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      SizedBox(
                                          width: 25,
                                          child: CustomText(text: '${rowIndex + 1}.', size: getFontSize(16, context), textAlign: TextAlign.center)),
                                      InkWell(
                                          onTap: () {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            text.splitMapJoin(
                              ...
                              onMatch: (m) {
                                ...
                                if (widget.correction.fillInTheGap!.type.toString().contains('sentence')) {
                                  String prefix = '${matches.toList()[controllerIndex].group(1) ?? ''}';
                                  listOfUserInputs.add('$prefix${controllers[index][controllerIndex].text}'.toLowerCase());
                                ...
                                spans.add(WidgetSpan(
                                    child: SizedBox(
                                        height: 20,
                                        width: (widget.correction.fillInTheGap!.type.toString().contains('sentence')
                                            ? ((answers[index].split(',')[controllerIndex].length * 5.0) + 50)
                                            : 25.0),
                                        child: TextField(
                                            readOnly: true,
                                            controller: controllers[index][controllerIndex],
                                            maxLength: widget.correction.fillInTheGap!.type.toString().contains('sentence')
                            ...
                            if (widget.correction.fillInTheGap!.type.toString().contains('word-part') &&
                                finalText.replaceAll(' ', '').toLowerCase() == answers[index].toLowerCase()) {
                              correctAnswerCount++;
                            } else if (widget.correction.fillInTheGap!.type.toString().contains('sentence') &&
                                listOfUserInputs.toString() == answers[index].split(',').toString().toLowerCase()) {
                              correctAnswerCount++;
                            }
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        child: RichText(
                                          ...
                                          WidgetSpan(
                                              child: SizedBox(width: 25, child: CustomText(text: "${index + 1}.", textAlign: TextAlign.center))),
                                          WidgetSpan(
                                              child: InkWell(
                                                  onTap: () {
                                                    if (widget.correction.fillInTheGap!.type.toString().contains('word-part')) {
