...
class Subscription extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final entitlement = Provider.of<EntitlementProvider>(context).entitlement;
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text("This is a must have app for every family to have just in case of a dental emergency."),
              SizedBox(
                height: height * 0.015,
              ),
              Text(
              ...
              Text("Have peace of mind when you experience a dental emergency. This app will connect you to Dr Nguyen anytime and anywhere."),
              SizedBox(
                height: height * 0.015,
              ),
              Row(
              ...
              height < 650 ? SizedBox(height: height * 0.03) : SizedBox(height: height * 0.06),
              Text(
                ...
                style: TextStyle(fontStyle: FontStyle.italic, color: Color(0xffADAADE), fontWeight: FontWeight.bold),
              )
            ],
          ),
        ),
  ...
  Widget buildEntitlement(Entitlement entitlement) {
    switch (entitlement) {
      case Entitlement.allcourses:
        return buildEntitlementIcon(text: "You are on paid plan", icon: Icons.payment);

      case Entitlement.free:
      default:
        return buildEntitlementIcon(text: "You are on free plan", icon: Icons.lock);
    }
  }
